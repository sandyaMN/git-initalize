...
let DialogEntityRegistryDetail = _decorate(null, function (_initialize, _LitElement) {
  ...
  return {
    ...
    d: [{
      ...
      value: function render() {
        ...
        const invalidDomainUpdate = Object(_common_entity_compute_domain__WEBPACK_IMPORTED_MODULE_6__["computeDomain"])(this._entityId.trim()) !== Object(_common_entity_compute_domain__WEBPACK_IMPORTED_MODULE_6__["computeDomain"])(this._params.entry.entity_id);
        return lit_element__WEBPACK_IMPORTED_MODULE_0__["html"]`
      <ha-paper-dialog
        with-backdrop
        opened
      ...
      >
        <h2>
          ${stateObj ? Object(_common_entity_compute_state_name__WEBPACK_IMPORTED_MODULE_7__["computeStateName"])(stateObj) : entry.name || entry.entity_id}
        </h2>
        <paper-dialog-scrollable>
          ${!stateObj ? lit_element__WEBPACK_IMPORTED_MODULE_0__["html"]`
                <div>
          ...
          <div class="form">
            <paper-input
              ...
              .placeholder=${stateObj ? Object(_common_entity_compute_state_name__WEBPACK_IMPORTED_MODULE_7__["computeStateName"])(stateObj) : ""}
            ...
            <div class="row">
              ...
              >
                <div>
                  ...
                  <div class="secondary">
                    ${this._disabledBy && this._disabledBy !== "user" ? this.hass.localize("ui.panel.config.entity_registry.editor.enabled_cause", "cause", this.hass.localize(`config_entry.disabled_by.${this._disabledBy}`)) : ""}
    ...
    `;
      ...
      value: async function _updateEntry() {
        ...
        try {
          await Object(_data_entity_registry__WEBPACK_IMPORTED_MODULE_8__["updateEntityRegistryEntry"])(this.hass, this._origEntityId, {
      ...
      value: async function _deleteEntry() {
        ...
        try {
          await Object(_data_entity_registry__WEBPACK_IMPORTED_MODULE_8__["removeEntityRegistryEntry"])(this.hass, this._entityId);
          this._params = undefined;
        } finally {
          this._submitting = false;
        }
