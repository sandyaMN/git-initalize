...
const demoEntitiesTeachingbirds = () => Object(_src_fake_data_entity__WEBPACK_IMPORTED_MODULE_0__["convertEntities"])({
  "sensor.pollen_grabo": {
...
const demoLovelaceTeachingbirds = () => ({
  title: "Home",
  views: [{
    cards: [{
