...
let StateBadge = _decorate(null, function (_initialize, _LitElement) {
  ...
  return {
    ...
    d: [{
      ...
      <ha-icon
        id="icon"
        data-domain=${Object(_common_entity_compute_state_domain__WEBPACK_IMPORTED_MODULE_2__["computeStateDomain"])(stateObj)}
