  ...
  return {
    ...
    `;
      ...
      value: function styles() {
        return [_resources_styles__WEBPACK_IMPORTED_MODULE_8__["haStyle"], lit_element__WEBPACK_IMPORTED_MODULE_7__["css"]`
        .discovery-text,
        .content-header {
          margin: 16px;
        }
