...
let DialogThingtalk = _decorate([Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["customElement"])("ha-dialog-thinktalk")], function (_initialize, _LitElement) {
  ...
  return {
    ...
    `;
      ...
      value: async function _generate() {
        ...
        try {
          const result = await Object(_data_cloud__WEBPACK_IMPORTED_MODULE_8__["convertThingTalk"])(this.hass, this._value);
      ...
      value: function styles() {
        return [_resources_styles__WEBPACK_IMPORTED_MODULE_7__["haStyle"], _resources_styles__WEBPACK_IMPORTED_MODULE_7__["haStyleDialog"], lit_element__WEBPACK_IMPORTED_MODULE_0__["css"]`
        ha-paper-dialog {
          max-width: 500px;
        }
        mwc-button.left {
  ...
  return {
    ...
    d: [{
      ...
      value: function hassSubscribe() {
        return [Object(_data_entity_registry__WEBPACK_IMPORTED_MODULE_4__["subscribeEntityRegistry"])(this.hass.connection, entries => {
            ...
            return lit_element__WEBPACK_IMPORTED_MODULE_0__["html"]`
                      ...
                      ${Object(_common_util_patch__WEBPACK_IMPORTED_MODULE_6__["getPath"])(this._placeholderValues, [type, placeholder.index, "device_id"]) && placeholder.fields.includes("entity_id") && Object(_common_util_patch__WEBPACK_IMPORTED_MODULE_6__["getPath"])(this._placeholderValues, [type, placeholder.index, "entity_id"]) === undefined || Object(_common_util_patch__WEBPACK_IMPORTED_MODULE_6__["getPath"])(this._manualEntities, [type, placeholder.index, "manual"]) === true ? lit_element__WEBPACK_IMPORTED_MODULE_0__["html"]`
                            <ha-entity-picker
                              ...
                              .hass=${this.hass}
                              .label=${this._getLabel(placeholder.domains, placeholder.device_classes)}
                              .entityFilter=${state => this._deviceEntityLookup[this._placeholderValues[type][placeholder.index].device_id].includes(state.entity_id)}
                            ></ha-entity-picker>
                          ` : ""}
                    `;
    ...
    `;
      ...
      value: function _isDone() {
        return Object.entries(this.placeholders).every(([type, placeholders]) => placeholders.every(placeholder => placeholder.fields.every(field => Object(_common_util_patch__WEBPACK_IMPORTED_MODULE_6__["getPath"])(this._placeholderValues, [type, placeholder.index, field]) !== undefined)));
      }
    }, {
      kind: "method",
      key: "_getLabel",
      value: function _getLabel(domains, deviceClasses) {
        return `${domains.map(domain => this.hass.localize(`domain.${domain}`)).join(", ")}${deviceClasses ? ` of type ${deviceClasses.join(", ")}` : ""}`;
      }
    }, {
      kind: "method",
      key: "_devicePicked",
      value: function _devicePicked(ev) {
        ...
        if (entities.length === 0) {
          ...
          this._error = `No ${placeholder.domains.map(domain => this.hass.localize(`domain.${domain}`)).join(", ")} entities found in this device.`;
      ...
      key: "styles",
      value: function styles() {
        return [_resources_styles__WEBPACK_IMPORTED_MODULE_2__["haStyleDialog"], lit_element__WEBPACK_IMPORTED_MODULE_0__["css"]`
        ha-paper-dialog {
          max-width: 500px;
        }
        mwc-button.left {
