...
var HaDevicePicker = _decorate([Object(lit_element__WEBPACK_IMPORTED_MODULE_6__["customElement"])("ha-device-picker")], function (_initialize, _SubscribeMixin) {
  var HaDevicePicker =
  /*#__PURE__*/
  function (_SubscribeMixin2) {
    _inherits(HaDevicePicker, _SubscribeMixin2);
    ...
    function HaDevicePicker() {
      ...
      _classCallCheck(this, HaDevicePicker);

      for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
        args[_key] = arguments[_key];
      }

      _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(HaDevicePicker)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  return {
    ...
    d: [{
      ...
      value: function value() {
        ...
        return Object(memoize_one__WEBPACK_IMPORTED_MODULE_5__["default"])(function (devices, areas, entities, includeDomains, excludeDomains, includeDeviceClasses) {
          if (!devices.length) {
            return [];
          }
          ...
          try {
            for (var _iterator2 = areas[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          ...
          var inputDevices = _toConsumableArray(devices);
          ...
          if (includeDomains) {
            inputDevices = inputDevices.filter(function (device) {
              ...
              return deviceEntityLookup[device.id].some(function (entity) {
                return includeDomains.includes(Object(_common_entity_compute_domain__WEBPACK_IMPORTED_MODULE_13__["computeDomain"])(entity.entity_id));
              });
            });
          }
          ...
          if (excludeDomains) {
            inputDevices = inputDevices.filter(function (device) {
              ...
              return entities.every(function (entity) {
                return !excludeDomains.includes(Object(_common_entity_compute_domain__WEBPACK_IMPORTED_MODULE_13__["computeDomain"])(entity.entity_id));
              });
            });
          }
          ...
          var outputDevices = inputDevices.map(function (device) {
            return {
              id: device.id,
              name: Object(_data_device_registry__WEBPACK_IMPORTED_MODULE_9__["computeDeviceName"])(device, _this2.hass, deviceEntityLookup[device.id]),
          ...
          return outputDevices.sort(function (a, b) {
      ...
      function hassSubscribe() {
        ...
        return [Object(_data_device_registry__WEBPACK_IMPORTED_MODULE_9__["subscribeDeviceRegistry"])(this.hass.connection, function (devices) {
          _this3.devices = devices;
        }), Object(_data_area_registry__WEBPACK_IMPORTED_MODULE_11__["subscribeAreaRegistry"])(this.hass.connection, function (areas) {
          _this3.areas = areas;
        }), Object(_data_entity_registry__WEBPACK_IMPORTED_MODULE_12__["subscribeEntityRegistry"])(this.hass.connection, function (entities) {
          _this3.entities = entities;
        })];
      }
    }, {
      kind: "method",
      ...
      value: function render() {
        ...
        var devices = this._getDevices(this.devices, this.areas, this.entities, this.includeDomains, this.excludeDomains, this.includeDeviceClasses);

        return Object(lit_element__WEBPACK_IMPORTED_MODULE_6__["html"])(_templateObject(), devices, this._value, rowRenderer, this._openedChanged, this._deviceChanged, this.label === undefined && this.hass ? this.hass.localize("ui.components.device-picker.device") : this.label, this.value ? Object(lit_element__WEBPACK_IMPORTED_MODULE_6__["html"])(_templateObject2(), this.hass.localize("ui.components.device-picker.clear"), this._clearValue) : "", devices.length > 0 ? Object(lit_element__WEBPACK_IMPORTED_MODULE_6__["html"])(_templateObject3(), this.hass.localize("ui.components.device-picker.show_devices"), this._opened ? "hass:menu-up" : "hass:menu-down") : "");
      }
    }, {
      kind: "method",
      key: "_clearValue",
      ...
      value: function _setValue(value) {
        ...
        this.value = value;
        setTimeout(function () {
          Object(_common_dom_fire_event__WEBPACK_IMPORTED_MODULE_8__["fireEvent"])(_this4, "value-changed", {
            value: value
          });
          Object(_common_dom_fire_event__WEBPACK_IMPORTED_MODULE_8__["fireEvent"])(_this4, "change");
        }, 0);
      }
    }, {
      kind: "get",
      ...
      value: function styles() {
        return Object(lit_element__WEBPACK_IMPORTED_MODULE_6__["css"])(_templateObject4());
      }
    }]
  };
  ...
  var SubscribeClass = _decorate(null, function (_initialize, _superClass) {
    ...
    function (_superClass2) {
      ...
      function SubscribeClass() {
        ...
        _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(SubscribeClass)).call.apply(_getPrototypeOf2, [this].concat(args)));
