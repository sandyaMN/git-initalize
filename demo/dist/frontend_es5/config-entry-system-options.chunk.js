...
var DialogConfigEntrySystemOptions = _decorate([Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["customElement"])("dialog-config-entry-system-options")], function (_initialize, _LitElement) {
  var DialogConfigEntrySystemOptions =
  /*#__PURE__*/
  function (_LitElement2) {
    _inherits(DialogConfigEntrySystemOptions, _LitElement2);
    ...
    function DialogConfigEntrySystemOptions() {
      ...
      _classCallCheck(this, DialogConfigEntrySystemOptions);

      for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
        args[_key] = arguments[_key];
      }

      _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(DialogConfigEntrySystemOptions)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  return {
    ...
    d: [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                this._loading = true;
                _context.next = 5;
                return regeneratorRuntime.awrap(Object(_data_config_entries__WEBPACK_IMPORTED_MODULE_5__["getConfigEntrySystemOptions"])(this.hass, params.entry.entry_id));

              case 5:
                systemOptions = _context.sent;
                this._loading = false;
      ...
      value: function render() {
        ...
        return Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject2(), this._openedChanged, this.hass.localize("ui.dialogs.config_entry_system_options.title", "integration", this.hass.localize("component.".concat(this._params.entry.domain, ".config.title")) || this._params.entry.domain), this._loading ? Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject3()) : Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject4(), this._error ? Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject5(), this._error) : "", !this._disableNewEntities, this._disableNewEntitiesChanged, this._submitting, this.hass.localize("ui.dialogs.config_entry_system_options.enable_new_entities_label"), this.hass.localize("ui.dialogs.config_entry_system_options.enable_new_entities_description", "integration", this.hass.localize("component.".concat(this._params.entry.domain, ".config.title")) || this._params.entry.domain)), !this._loading ? Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject6(), this._updateEntry, this._submitting, this.hass.localize("ui.panel.config.entity_registry.editor.update")) : "");
      }
    }, {
      kind: "method",
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.prev = 1;
                _context2.next = 4;
                return regeneratorRuntime.awrap(Object(_data_config_entries__WEBPACK_IMPORTED_MODULE_5__["updateConfigEntrySystemOptions"])(this.hass, this._params.entry.entry_id, {
      ...
      value: function styles() {
        return [_resources_styles__WEBPACK_IMPORTED_MODULE_6__["haStyleDialog"], Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["css"])(_templateObject7())];
      }
    }]
  };
