...
var DialogDeviceRegistryDetail = _decorate([Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["customElement"])("dialog-device-registry-detail")], function (_initialize, _LitElement) {
  var DialogDeviceRegistryDetail =
  /*#__PURE__*/
  function (_LitElement2) {
    ...
    function DialogDeviceRegistryDetail() {
      ...
      _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(DialogDeviceRegistryDetail)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    return DialogDeviceRegistryDetail;
  }(_LitElement);
  ...
  return {
    ...
    d: [{
      ...
      value: function render() {
        ...
        return Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject2(), this._openedChanged, Object(_data_device_registry__WEBPACK_IMPORTED_MODULE_10__["computeDeviceName"])(device, this.hass), this._error ? Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject3(), this._error) : "", this._nameByUser, this._nameChanged, this.hass.localize("ui.dialogs.more_info_settings.name"), device.name || "", this._submitting, this.hass.localize("ui.panel.config.devices.area_picker_label"), this._computeSelectedArea(), this._areaIndexChanged, this.hass.localize("ui.panel.config.integrations.config_entry.no_area"), this._renderAreas(), this._updateEntry, this.hass.localize("ui.panel.config.entity_registry.editor.update"));
      }
    }, {
      kind: "method",
      key: "_nameChanged",
      ...
      value: function _renderAreas() {
        ...
        return this._areas.map(function (area) {
          return Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject4(), area.name);
        });
      }
    }, {
      kind: "method",
      ...
      value: function _computeSelectedArea() {
        ...
        return this._areas.findIndex(function (area) {
      ...
      value: function _areaIndexChanged(event) {
        var selectedAreaIdx = event.target.selected;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.prev = 1;
                _context2.next = 4;
                return regeneratorRuntime.awrap(this._params.updateEntry({
              ...
              case 7:
                ...
                this._error = _context2.t0.message || this.hass.localize("ui.panel.config.devices.unknown_error");
      ...
      value: function styles() {
        return [_resources_styles__WEBPACK_IMPORTED_MODULE_8__["haStyleDialog"], Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["css"])(_templateObject5())];
      }
    }]
  };
