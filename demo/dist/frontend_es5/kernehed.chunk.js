...
var demoEntitiesKernehed = function demoEntitiesKernehed() {
  return Object(_src_fake_data_entity__WEBPACK_IMPORTED_MODULE_0__["convertEntities"])({
    ...
    "zone.ica_fjallbacken": {
      ...
      attributes: {
        hidden: true,
        radius: 50,
        friendly_name: "ICA Fj\xE4llbacken",
        icon: "mdi:cart"
      }
    },
    "zone.tempo": {
    ...
    "binary_sensor.unifi_camera": {
      ...
      state: "off",
      attributes: {
        friendly_name: "R\xF6relsesensor kamera",
        icon: "mdi:walk"
      }
    },
    "sensor.db_size": {
    ...
    "binary_sensor.back_door_sensor": {
      ...
      attributes: {
        battery_level: 88,
        on: true,
        friendly_name: "Altand\xF6rren sensor",
        device_class: "opening",
        icon: "mdi:door"
      }
    },
    ...
    "binary_sensor.trapp_motion_sensor": {
      ...
      attributes: {
        ...
        on: true,
        dark: true,
        friendly_name: "R\xF6relsesensor k\xE4llaren 1",
        device_class: "motion",
        icon: "mdi:walk"
      }
    },
    "binary_sensor.tvattstugan_motion_sensor": {
      ...
      attributes: {
        ...
        on: true,
        dark: true,
        friendly_name: "R\xF6relsesensor tv\xE4ttstugan",
        device_class: "motion",
        icon: "mdi:walk"
      }
    },
    ...
    "binary_sensor.skafferiet_motion_sensor": {
      ...
      attributes: {
        battery_level: 60,
        on: true,
        friendly_name: "R\xF6relsesensor skafferiet",
        device_class: "motion",
        icon: "mdi:walk"
      }
    },
    "binary_sensor.kallaren_motion_sensor": {
      ...
      attributes: {
        ...
        on: true,
        dark: true,
        friendly_name: "R\xF6relsesensor k\xE4llaren 2",
        device_class: "motion",
        icon: "mdi:walk"
      }
    },
...
var demoLovelaceKernehed = function demoLovelaceKernehed() {
  return {
    name: "Hem",
    resources: [// {
...
var demoThemeKernehed = function demoThemeKernehed() {
  return {
