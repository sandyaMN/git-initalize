...
var HuiPictureGlanceCardEditor = _decorate([Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["customElement"])("hui-picture-glance-card-editor")], function (_initialize, _LitElement) {
  var HuiPictureGlanceCardEditor =
  /*#__PURE__*/
  function (_LitElement2) {
    _inherits(HuiPictureGlanceCardEditor, _LitElement2);
    ...
    function HuiPictureGlanceCardEditor() {
      ...
      _classCallCheck(this, HuiPictureGlanceCardEditor);

      for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
        args[_key] = arguments[_key];
      }

      _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(HuiPictureGlanceCardEditor)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    d: [{
      ...
      value: function _valueChanged(ev) {
        ...
        if (ev.detail && ev.detail.entities) {
          ...
          if (this["_".concat(target.configValue)] === value || this["_".concat(target.configValue)] === target.config) {
            return;
          }
          ...
          if (value === "") {
            ...
            this._config = Object.assign({}, this._config, _defineProperty({}, target.configValue, value ? value : target.config));
          }
        }
