...
function (_LocalizeMixin) {
  ...
  _createClass(HaDialogAddUser, [{
    ...
    key: "_createUser",
    value: function _createUser(ev) {
      var userId, userResponse;
      return regeneratorRuntime.async(function _createUser$(_context) {
        while (1) {
