...
var computeStateDisplay = function computeStateDisplay(localize, stateObj, language) {
  var display;
...
var getRecentWithCache = function getRecentWithCache(hass, entityId, cacheConfig, localize, language) {
  ...
  var genProm = function genProm() {
    var fetchedHistory, results, stateHistory;
    return regeneratorRuntime.async(function genProm$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return regeneratorRuntime.awrap(Promise.all([curCacheProm, Object(_history__WEBPACK_IMPORTED_MODULE_0__["fetchRecent"])(hass, entityId, toFetchStartTime, endTime, appendingToCache)]));
      ...
      try {
        for (var _iterator3 = states[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
          ...
          if (DOMAINS_USE_LAST_UPDATED.includes(domain)) {
            ...
            try {
              for (var _iterator4 = LINE_ATTRIBUTES_TO_KEEP[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
