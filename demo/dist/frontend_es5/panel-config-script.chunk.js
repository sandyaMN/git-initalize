...
var triggerScript = function triggerScript(hass, entityId, variables) {
  return hass.callService("script", Object(_common_entity_compute_object_id__WEBPACK_IMPORTED_MODULE_0__["computeObjectId"])(entityId), variables);
};
      ...
      return regeneratorRuntime.async(function _delete$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              _context.next = 4;
              return regeneratorRuntime.awrap(Object(_data_script__WEBPACK_IMPORTED_MODULE_16__["deleteScript"])(this.hass, Object(_common_entity_compute_object_id__WEBPACK_IMPORTED_MODULE_11__["computeObjectId"])(this.script.entity_id)));
  ...
  return {
    ...
    d: [{
      ...
      value: function render() {
        ...
        return Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject(), this.hass.localize("ui.panel.config.script.caption"), this.isWide, this.hass.localize("ui.panel.config.script.picker.header"), this.hass.localize("ui.panel.config.script.picker.introduction"), this.hass.localize("ui.panel.config.script.picker.learn_more"), this.scripts.length === 0 ? Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject2(), this.hass.localize("ui.panel.config.script.picker.no_scripts")) : this.scripts.map(function (script) {
          return Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject3(), script, _this2.hass.localize("ui.panel.config.script.picker.trigger_script"), _this2._runScript, Object(_common_entity_compute_state_name__WEBPACK_IMPORTED_MODULE_8__["computeStateName"])(script), "/config/script/edit/".concat(script.entity_id), _this2.hass.localize("ui.panel.config.script.picker.edit_script"));
        }), this.isWide, this.hass.localize("ui.panel.config.script.picker.add_script"), Object(_common_util_compute_rtl__WEBPACK_IMPORTED_MODULE_4__["computeRTL"])(this.hass));
      }
    }, {
      kind: "method",
      key: "_runScript",
      value: function _runScript(ev) {
        var script;
        return regeneratorRuntime.async(function _runScript$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                script = ev.currentTarget.script;
                _context.next = 3;
                return regeneratorRuntime.awrap(Object(_data_script__WEBPACK_IMPORTED_MODULE_10__["triggerScript"])(this.hass, script.entity_id));
