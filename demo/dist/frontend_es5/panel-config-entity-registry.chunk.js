...
var HaConfigEntityRegistry = _decorate(null, function (_initialize, _LitElement) {
  ...
  function (_LitElement2) {
    ...
    function HaConfigEntityRegistry() {
      ...
      _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(HaConfigEntityRegistry)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  return {
    ...
    d: [{
      ...
      value: function value() {
        ...
        return Object(memoize_one__WEBPACK_IMPORTED_MODULE_11__["default"])(function (_language) {
          return {
            icon: {
              title: "",
              type: "icon",
              template: function template(icon) {
                return Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject(), icon);
              }
            },
            name: {
              title: _this2.hass.localize("ui.panel.config.entity_registry.picker.headers.name"),
              sortable: true,
              filterable: true,
              direction: "asc"
            },
            entity_id: {
              title: _this2.hass.localize("ui.panel.config.entity_registry.picker.headers.entity_id"),
              sortable: true,
              filterable: true
            },
            platform: {
              title: _this2.hass.localize("ui.panel.config.entity_registry.picker.headers.integration"),
              sortable: true,
              filterable: true,
              template: function template(platform) {
                return Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject2(), _this2.hass.localize("component.".concat(platform, ".config.title")) || platform);
              }
            },
            disabled_by: {
              title: _this2.hass.localize("ui.panel.config.entity_registry.picker.headers.enabled"),
              type: "icon",
              template: function template(disabledBy) {
                return Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["html"])(_templateObject3(), disabledBy ? "hass:cancel" : "hass:check-circle");
              }
            }
          };
        });
      ...
      value: function value() {
        ...
        return Object(memoize_one__WEBPACK_IMPORTED_MODULE_11__["default"])(function (entities, showDisabled) {
          return (showDisabled ? entities : entities.filter(function (entity) {
            return !Boolean(entity.disabled_by);
          })).map(function (entry) {
            var state = _this3.hass.states[entry.entity_id];
            return Object.assign({}, entry, {
              ...
              name: Object(_data_entity_registry__WEBPACK_IMPORTED_MODULE_1__["computeEntityRegistryName"])(_this3.hass, entry) || _this3.hass.localize("state.default.unavailable")
            });
          });
        });
      }
      ...
      value: function updated(changedProps) {
        ...
        if (!this._unsubEntities) {
          this._unsubEntities = Object(_data_entity_registry__WEBPACK_IMPORTED_MODULE_1__["subscribeEntityRegistry"])(this.hass.connection, function (entities) {
            _this4._entities = entities;
          });
        }
      }
    }, {
      ...
      value: function _openEditEntry(ev) {
        ...
        var entry = this._entities.find(function (entity) {
          return entity.entity_id === entryId;
        });
...
var showEntityRegistryDetailDialog = function showEntityRegistryDetailDialog(element, systemLogDetailParams) {
