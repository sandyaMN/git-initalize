...
function (_EventsMixin) {
  ...
  _createClass(ZwaveLogDialog, [{
    ...
    key: "_refreshLog",
    value: function _refreshLog() {
      var info;
      return regeneratorRuntime.async(function _refreshLog$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return regeneratorRuntime.awrap(this.hass.callApi("GET", "zwave/ozwlog?lines=" + this._numLogLines));
