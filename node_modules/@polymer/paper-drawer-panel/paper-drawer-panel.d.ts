 ...
 */
interface PaperDrawerPanelElement extends IronResizableBehavior, LegacyElementMixin, HTMLElement {
   ...
   */
  drawerToggleAttribute: string|null|undefined;
...
export {PaperDrawerPanelElement};
